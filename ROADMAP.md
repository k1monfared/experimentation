...
- How
  ...
  - Add .github/workflows/privacy.yml or a pre-commit hook that runs the existing grep guards (claude / anthropic / co-authored-by) on staged content, fails the commit if any match in tracked files.
