...
- Observe
  ...
  - These per-segment effects are illustrative numbers we picked to make the external-validity point, not predictions from a biological or pharmacological model of alcohol response.
