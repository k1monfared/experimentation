...
- Frequentist: two standard routes.
  ...
  - Cochran-Mantel-Haenszel is the classical combiner; we do not run it here because the per-segment + correction route is what most teams use, and the logistic-regression-with-interactions route generalizes more naturally.
