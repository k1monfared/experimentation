...
- Hunch
  - Pooling discards information. The canonical frequentist combiner that respects the strata is the Cochran-Mantel-Haenszel test; we will revisit this in chapter 11 when we talk about behavioural segmentation, and chapter 12 when subgroups openly contradict the pool (Simpson's paradox).
