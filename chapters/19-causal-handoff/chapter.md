...
- Try
  - Simulate 5,000 users with a latent "propensity" attribute. Propensity is a confounder here, a common cause of both treatment assignment and outcome. Treatment is more likely when propensity is high (sigmoid in propensity). True treatment effect = +0.30. Outcome = propensity + 0.30 * treated + noise.
- Observe
